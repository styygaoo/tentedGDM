...
#     def update(self, irmse, imae, mse, rmse, mae, rmse_log, absrel, lg10, delta1, delta2, delta3, gpu_time, data_time):                  # changed the order
#         self.irmse, self.imae = irmse, imae
#         self.mse, self.rmse, self.mae = mse, rmse, mae
#         self.rmse_log = rmse_log
#         self.absrel, self.lg10 = absrel, lg10
...
#
#     def evaluate(self, output, target):
#         # print("torch.isinf(output).any(): ", torch.isinf(output).any())
#         # print("torch.isinf(target).any(): ", torch.isinf(target).any())
#
#
#         abs_diff = (output - target).abs()
#
...
#
#
#         plot_mse.append(self.mse)
#         plot_rmse.append(self.rmse)
#         plot_mae.append(self.mae)
#
#
#
#         maxRatio = torch.max(output / target, target / output)
...
#             self.sum_gpu_time / self.count, self.sum_data_time / self.count)
#
#         return avg, plot_mse, plot_rmse, plot_mae
